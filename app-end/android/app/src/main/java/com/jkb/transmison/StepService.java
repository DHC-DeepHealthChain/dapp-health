...
//        (String) sp.getParam("planWalk_QTY", "7000");
...
//        List<StepData> list = DbUtils.getQueryByWhere(StepData.class, "today", new String[]{CURRENT_DATE});
        CURRENT_STEP = (Integer) sp.getParam("walkNumber",0);
        if (mStepCount != null) {
...
//        int tempStep = CURRENT_STEP;
        sp.setParam("walkNumber",CURRENT_STEP);
//        List<StepData> list = DbUtils.getQueryByWhere(StepData.class, "today", new String[]{CURRENT_DATE});
