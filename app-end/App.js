...
export default class App extends Component<Props> {
  ...
  getCallBackTime() {
    NativeModules.TransMissonMoudle.callBackTime("ZPengs", msg => {
      console.log(msg);
      ToastAndroid.show(
        `${"CallBack收到消息:" + "\n"}${msg}`,
        ToastAndroid.SHORT
  ...
  getPromiseTime() {
    NativeModules.TransMissonMoudle.sendPromiseTime("ZPengs")
      .then(msg => {
        console.log(`年龄:${msg.age}/n` + `时间:${msg.time}`);
        ToastAndroid.show(
          `${"Promise收到消息:" + "\n" + "年龄:"}${msg.age}时间:${msg.time}`,
          ToastAndroid.SHORT
        );
